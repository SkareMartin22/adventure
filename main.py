...
dexterity= int(input("How is your dexterity? (1-100)\n>"))
...
if choice == "1":
    ...
    if roll > 30:
        print("The wall is moved by your compelling arguement and lets you pass as it cries. ")

    else:
        print("It's a wall, what did you expect? Try again idiot.")
